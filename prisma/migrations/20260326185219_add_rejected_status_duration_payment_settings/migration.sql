...
-- AlterTable
ALTER TABLE `job` ADD COLUMN `duration` INTEGER NULL,
    ADD COLUMN `paymentMethod` VARCHAR(191) NULL,
    ADD COLUMN `rejectReason` VARCHAR(191) NULL,
    ADD COLUMN `rejectedAt` DATETIME(3) NULL,
    MODIFY `status` ENUM('CREATED', 'ASSIGNED', 'ACCEPTED', 'IN_PROGRESS', 'WAITING_APPROVAL', 'WAITING_OTP', 'COMPLETED', 'CLOSED', 'REJECTED') NOT NULL DEFAULT 'CREATED';
